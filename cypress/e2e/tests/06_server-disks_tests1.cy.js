...
describe('6.Servers - Disks tab Part1', () => {
    ...
    //     serverDisksPage.actions.writeNewDiskNameTxt(diskName)
    //     serverDisksPage.actions.clickDiskTypeHDDBtn()
    //     serverDisksPage.actions.setDiskSize("+")
    //     serverDisksPage.actions.clickConfirmNewDiskBtn()
    ...
    it("Attach disk (for this any global disk must be available)", () => {
        ...
        serverAction_page.actions.checkStatus(12, 'Остановлен')
        serverDisksPage.actions.clickServerDisksTab()
        serverDisksPage.actions.clickConnectNewServerDiskBtn()
        serverDisksPage.actions.clickConnectDiskSelector()
        serverDisksPage.actions.selectConnectDiskOption(configData.test_disk)
    ...
    it("Detach disk and ensure it appears in the global disks page", () => {
        ...
        serverAction_page.actions.checkStatus(12, 'Остановлен')
        serverDisksPage.actions.clickServerDisksTab()
        serverDisksPage.actions.clickDiskDisconnectBtn(configData.test_disk)
        serverDisksPage.actions.clickDisconnectDiskModalBtn()
        sidebar.actions.clickDisksIcon()
        serverDisksPage.actions.checkDiskUnderThisNameExists(configData.test_disk)
    })
