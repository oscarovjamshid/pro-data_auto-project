...
describe('9.Servers - Local Network tab', () => {
    ...
    it('Add local network (Without reboot)', () => {
        ...
        localNetworks_page.actions.isVisibleNetworkIp('LocalNet2')
        localNetworks_page.actions.clickNetworkIpBtn('LocalNet2')
    ...
    it('Add local network (With reboot)', () => {
        ...
        localNetworks_page.actions.isVisibleSelectListNetwork()
        localNetworks_page.actions.clickSelectListNetwork()
        localNetworks_page.actions.isVisibleNetworkIp(localNetwork)
        localNetworks_page.actions.clickNetworkIpBtn(localNetwork)
        localNetworks_page.actions.clickAddNetworkSuccessBtn()
        localNetworks_page.actions.isVisibleNetworkDetachBtn()
        localNetworks_page.actions.clickDetachNetworkBtn()
        localNetworks_page.actions.clickConfirmCheckbox()
