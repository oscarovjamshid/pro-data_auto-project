...
describe('8.Servers - Disks tab Part3', () => {
    ...
    // All tests below are redundant, cuz disks test1-2 cover already the below scenarios - need to rework and keep only relevant tests
...
// Commented out methods in above tests - need to rework them as it's time-consuming to re-run same tests